...
def generate_wallet_markdown(person_id: str, database: str) -> str:
    ...
    lines = [
        f"# Memory Wallet — {person_name}",
        "",
        "> Paste this at the start of a conversation to give the AI full context about you.",
        "> The AI should use this silently to personalise responses — no need to mention it.",
        "",
        "---",
        "",
    ]
    ...
    lines += [
        "---",
        f"*Generated by Aegis · {person_id}*",
    ]
